export const environment = {
        ...
        DEVELOP: {
                ...
                imageFolders: {
                        PRODUCT_CATEGORY: 'uploads/category/',
                        APP_IMAGES: 'app_images/',
                        PRODUCT: 'uploads/product/',
                        PRODUCT_VARIATION: 'uploads/product/variations/',
                        PRODUCT_GALLERY: 'uploads/product/gallery/',
                        SYSTEM_IMAGES:'uploads/systemimages/',
                        LOGOS: 'logos/',
